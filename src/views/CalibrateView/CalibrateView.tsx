  ...
  return (
    <>
      <Card
        ...
        <Meta description="Konum sapmalarını gidermek için bir kalibrasyon yapılması gerekmektedir. Pusulanınızı kalibre etmek için telefonunuzla 8 çizmeniz gerekmektedir. Cihazınızı aşağıdaki şekilde 3 kez eğin ve hareket ettirin. Tamamladığınızda Bitti’yi tıklayın." />
      </Card>
    </>
  )
}
