...
export const CalibrateView = () => {
  ...
  return (
    <>
      <Card
        style={{ width: '100%', border: 0 }}
        cover={<img alt="example" src={compass_calibration} />}>
        <Meta
          description="Konum sapmalarını gidermek için bir
         kalibrasyon yapılması gerekmektedir. Pusulanınızı kalibre etmek için
