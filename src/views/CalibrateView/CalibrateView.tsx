    ...
    <>
      <Card
        ...
        <Paragraph>
          <Paragraph>- Android cihazınızı açın.</Paragraph>
          <Paragraph>
            - Telefonunuzu tutun ve pusulanız kalibre olana kadar havada bir 8
            rakamı deseni yapın. Genellikle, 8 rakamı hareketini sadece birkaç
            kez yapmanız gerekecektir.
          </Paragraph>
          <Paragraph>
            - Pusulanın doğru yönü gösterdiğini doğrulamak için tercih ettiğiniz
            navigasyon uygulamasını (örneğin, Google Haritalar) açın.
          </Paragraph>
        </Paragraph>
      </Card>
    </>
