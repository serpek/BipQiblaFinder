...
export function useDevicePermissions() {
  ...
  const requestLocation = useCallback(() => {
    if (!navigator.geolocation) {
      setLocation({ latitude: null, longitude: null, error: "Geolocation desteklenmiyor." });
      return;
    }
  ...
  return { location, orientation, requestLocation, requestMotionPermission, geoPermission, motionPermission };
}
